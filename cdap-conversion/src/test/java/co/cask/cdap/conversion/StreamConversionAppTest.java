...
public class StreamConversionAppTest extends TestBase {
  ...
  public void testMapReduce() throws Exception {
    ...
    Schema schema = new Schema.Parser().parse(fileSet.getOutputFormatConfiguration().get("schema"));
